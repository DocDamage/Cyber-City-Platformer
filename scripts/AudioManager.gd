...
const SFX_PATHS := {
	...
	&"footstep": "res://assets/runtime/audio/sfx/FREE Retro Action Platformer Sound Effects/Snap_3.ogg",
	&"land": "res://assets/runtime/audio/sfx/FREE Retro Action Platformer Sound Effects/Thudd2.ogg",
	&"conveyor": "res://assets/runtime/audio/sfx/FREE Retro Action Platformer Sound Effects/Clang3.ogg",
