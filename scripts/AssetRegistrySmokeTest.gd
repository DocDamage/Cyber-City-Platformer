...
func _run() -> void:
	...
	assert(canonical_prop.resource_path == "res://assets/runtime/props/LunarProps/Space Props/Space extra (1).png")
	...
	assert(parallax != null and parallax.resource_path == "res://assets/runtime/environments/parallax/Rooftops 2/back.png")
	assert(vfx != null and vfx.resource_path == "res://assets/runtime/vfx/Pack 6/PNG sheet/Effect (1)-Sheet.png")
