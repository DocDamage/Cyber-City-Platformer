...
const ACT_VISUALS := {
	1: {
		"far": "res://assets/runtime/environments/parallax/Rooftops 2/back.png",
		"middle": "res://assets/runtime/environments/parallax/Rooftops 2/middle.png",
		"front": "res://assets/runtime/environments/parallax/Rooftops 2/front.png",
		"music": "res://assets/runtime/audio/music/Rooftops 2/cyberpunk city 2.ogg",
		"tile_set": "res://Stages/TileSets/Act1_Rooftops2_Palette.tres",
		"tint": Color(0.82, 0.9, 1.0),
	},
	2: {
		"far": "res://assets/runtime/environments/parallax/Neon Alley/Assets/layers/back.png",
		"middle": "res://assets/runtime/environments/parallax/Neon Alley/Assets/layers/middle.png",
		"front": "res://assets/runtime/environments/parallax/Neon Alley/Assets/layers/front.png",
		"music": "res://assets/runtime/audio/music/Robot Factory/Mega Robot Factory – 2 .ogg",
		"tile_set": "res://Stages/TileSets/Act2_RobotFactory_Palette.tres",
		"tint": Color(0.92, 0.78, 1.0),
	},
	3: {
		"far": "res://assets/runtime/environments/parallax/Moonlight City/Assets/layers/back.png",
		"middle": "res://assets/runtime/environments/parallax/Moonlight City/Assets/layers/middle.png",
		"front": "res://assets/runtime/environments/parallax/Moonlight City/Assets/layers/front.png",
		"music": "res://assets/runtime/audio/music/Street Beats/DavidKBD - Street Beat - System Glitch-essential-edition.ogg",
		"tile_set": "res://Stages/TileSets/Act3_NeonMoon_Palette.tres",
		"tint": Color(0.7, 0.86, 1.0),
	},
	4: {
		"far": "res://assets/runtime/environments/Act4_AbyssalNight/Abyssal Night/Abyssal Night – Color (2)/Backgroud/backgroud (1).png",
		"middle": "res://assets/runtime/environments/Act4_AbyssalNight/Abyssal Night/Abyssal Night – Color (2)/Backgroud/backgroud (2).png",
		"front": "res://assets/runtime/environments/Act4_AbyssalNight/Abyssal Night/Abyssal Night – Color (2)/Backgroud/backgroud (4).png",
		"music": "res://assets/runtime/audio/music/Boss Battles/Loops/Ogg/6. Dread Requiem (Loop).ogg",
...
const ACT_PROPS := {
	1: [
		{"texture": "res://assets/runtime/props/CyberCityProps/Rooftops 2/banner-a/banner-a1.png", "height": 76.0},
		{"texture": "res://assets/runtime/props/CyberCityProps/Rooftops 2/banner-c/banner-c2.png", "height": 76.0},
		{"texture": "res://assets/runtime/props/CyberCityProps/Rooftops 2/lights/lights2.png", "height": 82.0},
	],
	2: [
		{"texture": "res://assets/runtime/props/FactoryProps/Mega Robot Factory/CENA COLOR (2)/TILESET/Tileset.png", "region": Rect2(0, 0, 160, 128), "height": 112.0},
		{"texture": "res://assets/runtime/props/FactoryProps/Mega Robot Factory/CENA COLOR (2)/TILESET/Tileset.png", "region": Rect2(192, 0, 160, 128), "height": 112.0},
		{"texture": "res://assets/runtime/props/FactoryProps/Mega Robot Factory/CENA COLOR (2)/TILESET/Tileset.png", "region": Rect2(160, 128, 160, 48), "height": 52.0},
	],
	3: [
		{"texture": "res://assets/runtime/props/LunarProps/Space Props/space extra (125).png", "height": 62.0},
		{"texture": "res://assets/runtime/props/LunarProps/Space Props/space extra (154).png", "height": 72.0},
		{"texture": "res://assets/runtime/props/LunarProps/Neon Moon Portal/portal 96x96(1).png", "region": Rect2(0, 0, 96, 96), "height": 94.0},
	],
	4: [
		{"texture": "res://assets/runtime/props/VoidProps/Abyssal Night/Abyssal Night – Color (2)/effect/effect 96x96 (3).png", "region": Rect2(0, 0, 96, 96), "height": 82.0},
		{"texture": "res://assets/runtime/props/VoidProps/Abyssal Night/Abyssal Night – Color (2)/effect/effect 96x96 (3).png", "region": Rect2(192, 96, 96, 96), "height": 82.0},
		{"texture": "res://assets/runtime/props/VoidProps/Abyssal Night/Abyssal Night – Color (2)/effect/effect 96x96 (3).png", "region": Rect2(384, 192, 96, 96), "height": 76.0},
	],
}
